...
<?php $__env->startSection('title', 'Customer Management - NepSole'); ?>
...
<div class="stats-row">
    <div class="stat-mini">
        ...
        <div>
            ...
            <div class="stat-mini-value"><?php echo e($customers->total()); ?></div>
        </div>
    </div>
    <div class="stat-mini">
        ...
        <div>
            ...
            <div class="stat-mini-value"><?php echo e($customers->getCollection()->where('email_verified_at', '!=', null)->count()); ?></div>
        </div>
    </div>
    <div class="stat-mini">
        ...
        <div>
            ...
            <div class="stat-mini-value"><?php echo e($customers->getCollection()->whereNull('email_verified_at')->count()); ?></div>
        </div>
    </div>
</div>
    ...
    <div class="table-wrap">
        <table id="customersTable">
            ...
            <tbody>
                ...
                <tr>
                    <td style="color:#9ca3af;"><?php echo e($customer->id); ?></td>

                    <td>
                        <div class="user-cell">
                            <?php if($customer->profile_image): ?>
                                <img src="<?php echo e(asset('storage/' . $customer->profile_image)); ?>" class="user-avatar" alt="">
                            <?php else: ?>
                            ...
                            <?php endif; ?>
                            <div>
                                <div class="user-name"><?php echo e($customer->name); ?></div>
                                <div class="user-email"><?php echo e($customer->email); ?></div>
                            </div>
                        </div>
                    </td>

                    <td>
                        <span style="font-weight:600;"><?php echo e($customer->orders_count); ?></span>
                    ...
                    <td style="color:#6b7280;"><?php echo e($customer->created_at->format('M d, Y')); ?></td>

                    <td>
                        <div style="display:flex;gap:0.5rem;flex-wrap:wrap;">
                            <!-- Toggle Status -->
                            <form method="POST" action="<?php echo e(route('admin.customers.toggle', $customer->id)); ?>" style="display:inline;">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PATCH'); ?>
                                <button type="submit" class="action-btn <?php echo e($customer->email_verified_at ? 'btn-disable' : 'btn-enable'); ?>">
                                    <?php echo e($customer->email_verified_at ? 'Disable' : 'Enable'); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Nepsole\resources\views/admin/customers/index.blade.php ENDPATH**/ ?>