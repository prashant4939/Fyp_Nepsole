...
<body>
    <div class="container">
        ...
        <div class="form-card">
            ...
            <form method="POST" action="<?php echo e(route('vendor.register')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="pan_number" name="pan_number" value="<?php echo e(old('pan_number')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select id="business_type" name="business_type" required>
                            ...
                            <option value="sole_proprietorship" <?php echo e(old('business_type') == 'sole_proprietorship' ? 'selected' : ''); ?>>Sole Proprietorship</option>
                            <option value="partnership" <?php echo e(old('business_type') == 'partnership' ? 'selected' : ''); ?>>Partnership</option>
                            <option value="private_limited" <?php echo e(old('business_type') == 'private_limited' ? 'selected' : ''); ?>>Private Limited</option>
                            <option value="llp" <?php echo e(old('business_type') == 'llp' ? 'selected' : ''); ?>>LLP</option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <?php $__errorArgs = ['citizenship_certificate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="help-text">Upload PDF, JPG, JPEG, or PNG (Max: 2MB)</div>
                        <?php $__errorArgs = ['company_registration_certificate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="help-text">Upload PDF, JPG, JPEG, or PNG (Max: 2MB)</div>
                        <?php $__errorArgs = ['tax_certificate'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
</html><?php /**PATH C:\Users\user\Desktop\Fyp_Nepsole\Fyp_Nepsole\resources\views/vendor/register.blade.php ENDPATH**/ ?>