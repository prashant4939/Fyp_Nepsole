...
<?php $__env->startSection('title', 'My Orders - NepSole'); ?>
    ...
    <div class="container">
            ...
            <div class="order-card">
                <div class="order-header">
                    <div class="order-meta">
                        <span class="order-id">Order #<?php echo e($order->id); ?></span>
                ...
                <div class="order-items-preview">
                    ...
                    <?php if($order->orderItems->count() > 3): ?>
                        <div class="more-items">+<?php echo e($order->orderItems->count() - 3); ?> more</div>
                    <?php endif; ?>
                </div>
                ...
                <div class="order-footer">
                    <div class="order-total">
                        ...
                        <span class="total-value">Rs. <?php echo e(number_format($order->total_price, 2)); ?></span>
                    </div>
                    <div class="order-payment">
                        <span class="payment-method"><?php echo e($order->payment_method_label); ?></span>
                    </div>
                    <a href="<?php echo e(route('orders.show', $order)); ?>" class="btn-view">View Details →</a>
                </div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="empty-state">
                ...
                <a href="<?php echo e(route('products.index')); ?>" class="btn-primary">Browse Products</a>
            </div>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Nepsole\resources\views/customer/orders/index.blade.php ENDPATH**/ ?>