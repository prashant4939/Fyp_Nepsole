...
<?php $__env->startSection('title', 'My Wishlist - NepSole'); ?>
        ...
        <?php if($wishlistItems->count() > 0): ?>
            <div class="wishlist-grid">
                <?php $__currentLoopData = $wishlistItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="wishlist-card" data-wishlist-id="<?php echo e($item->id); ?>">
                        <button class="remove-btn" onclick="removeItem(<?php echo e($item->id); ?>)" title="Remove from wishlist">
                            <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                            </svg>
                        </button>
                        
                        <a href="<?php echo e(route('products.show', $item->product)); ?>" class="product-link">
                            ...
                            <div class="product-info">
                                <?php if($item->product->brand): ?>
                                    <span class="product-brand"><?php echo e($item->product->brand->name); ?></span>
                                <?php endif; ?>
                                <h3><?php echo e($item->product->name); ?></h3>
                                <p class="product-category"><?php echo e($item->product->category->name); ?></p>
                                <p class="product-price">Rs. <?php echo e(number_format($item->product->price, 2)); ?></p>
                            </div>
                        </a>
                        
                        <button class="add-to-cart-btn" onclick="moveToCart(event, <?php echo e($item->product->id); ?>, <?php echo e($item->id); ?>)">
                            <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\Fyp_Nepsole\Fyp_Nepsole\resources\views/customer/wishlist/index.blade.php ENDPATH**/ ?>