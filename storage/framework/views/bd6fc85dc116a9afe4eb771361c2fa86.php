...
<?php $__env->startSection('title', 'Add Product - Vendor'); ?>
        ...
        <div class="card-body">
            <div class="form-row-2">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" value="<?php echo e(old('name')); ?>" placeholder="Enter product name" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-with-icon">
                        ...
                        <input type="number" id="price" name="price" value="<?php echo e(old('price')); ?>" placeholder="0.00" step="0.01" min="0" required>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" rows="3" placeholder="Brief product description..."><?php echo e(old('description')); ?></textarea>
            </div>

            <div class="form-row-3">
                <div class="form-group">
                    <label for="product_details">Details</label>
                    <textarea id="product_details" name="product_details" rows="3" placeholder="Product specifications..."><?php echo e(old('product_details')); ?></textarea>
                </div>

                <div class="form-group">
                    <label for="size_and_fit">Size & Fit</label>
                    <textarea id="size_and_fit" name="size_and_fit" rows="3" placeholder="Sizing information..."><?php echo e(old('size_and_fit')); ?></textarea>
                </div>

                <div class="form-group">
                    <label for="handle_and_care">Care</label>
                    <textarea id="handle_and_care" name="handle_and_care" rows="3" placeholder="Care instructions..."><?php echo e(old('handle_and_care')); ?></textarea>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\Fyp_Nepsole\Fyp_Nepsole\resources\views/vendor/products/create.blade.php ENDPATH**/ ?>