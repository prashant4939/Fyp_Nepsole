                    ...
                    <div class="settings-dropdown-wrap">
                        ...
                        <div class="settings-dropdown-menu" id="settingsDropdownMenu">
                            <div class="settings-dropdown-header">
                                <div class="sd-avatar"><?php echo e(strtoupper(substr(auth()->user()->name, 0, 1))); ?></div>
                                <div>
                                    <div class="sd-name"><?php echo e(auth()->user()->name); ?></div>
                                    <div class="sd-role"><?php echo e(ucfirst(auth()->user()->role)); ?></div>
                                </div>
                            </div>
                            <div class="sd-divider"></div>
                            <a href="<?php echo e(route('settings.profile')); ?>" class="sd-item">
                                <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                                </svg>
                                View Profile
                            </a>
                            <a href="<?php echo e(route('settings.change-password')); ?>" class="sd-item">
                                <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            ...
                            <form id="settings-logout-form" method="POST" action="<?php echo e(route('logout')); ?>" style="display:none;">
                                <?php echo csrf_field(); ?>
                            </form>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\Nepsole\resources\views/components/navbar.blade.php ENDPATH**/ ?>