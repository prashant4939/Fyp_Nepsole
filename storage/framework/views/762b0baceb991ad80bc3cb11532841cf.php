...
<?php $__env->startSection('title', $product->name . ' - NepSole'); ?>
            ...
            <div class="product-gallery">
                <?php if($product->images->count() > 0): ?>
                    <div class="main-image">
                        <img src="<?php echo e(asset('storage/' . $product->images->first()->image)); ?>" alt="<?php echo e($product->name); ?>" id="mainImage">
                    </div>
                        ...
                        <div class="thumbnail-gallery">
                            <?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="thumbnail <?php echo e($index === 0 ? 'active' : ''); ?>" 
                                     onclick="changeImage('<?php echo e(asset('storage/' . $image->image)); ?>', <?php echo e($index); ?>, this)"
                                     data-image-index="<?php echo e($index); ?>">
                                    <img src="<?php echo e(asset('storage/' . $image->image)); ?>" alt="Thumbnail <?php echo e($index + 1); ?>">
                                </div>
            ...
            <div class="product-info">
                ...
                <?php if($product->description): ?>
                    <div class="info-section">
                        <p class="description-text"><?php echo e($product->description); ?></p>
                    </div>
                <?php endif; ?>
                ...
                <?php if($product->images->count() > 0): ?>
                    <div class="sizes-section">
                        ...
                        <?php $__currentLoopData = $product->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imageIndex => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="sizes-container" id="sizes-<?php echo e($imageIndex); ?>" style="<?php echo e($imageIndex === 0 ? '' : 'display: none;'); ?>">
                                <?php if($image->variants->count() > 0): ?>
                                    <div class="sizes-grid">
                                        <?php $__currentLoopData = $image->variants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <button type="button" 
                                                    class="size-option <?php echo e($variant->stock > 0 ? '' : 'out-of-stock'); ?>" 
                                                    onclick="selectSize(<?php echo e($variant->id); ?>, '<?php echo e($variant->size); ?>', <?php echo e($variant->stock); ?>)"
                                                    <?php echo e($variant->stock > 0 ? '' : 'disabled'); ?>>
                                                <span class="size-label"><?php echo e($variant->size); ?></span>
            ...
            <div class="related-section">
                ...
                <div class="related-grid">
                    <?php $__currentLoopData = $relatedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('products.show', $related)); ?>" class="related-card">
                            <div class="related-image">
                                <?php if($related->images->count() > 0): ?>
                                    <img src="<?php echo e(asset('storage/' . $related->images->first()->image)); ?>" alt="<?php echo e($related->name); ?>">
                                <?php else: ?>
                                    <div class="no-image">
                            ...
                            <div class="related-info">
                                ...
                                <p class="related-price">Rs. <?php echo e(number_format($related->price, 2)); ?></p>
                            </div>
                        </a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Desktop\Fyp_Nepsole\Fyp_Nepsole\resources\views/customer/products/show.blade.php ENDPATH**/ ?>