...
@section('title', 'Manage Customers - NepSole')
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form method="POST" action="{{ route('admin.users.toggle', $customer->id) }}" style="display: inline;">
                            @csrf
                        ...
                        <form method="POST" action="{{ route('admin.users.delete', $customer->id) }}" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this customer?');">
                            @csrf
                            @method('DELETE')
                ...
                @empty
                <tr>
                    <td colspan="8" style="text-align: center; color: #9ca3af; padding: 2rem;">No customers found</td>
                </tr>
                @endforelse
            </tbody>
        </table>
