...
<head>
    ...
    <title>Vendor Details - {{ $vendor->business_name }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            ...
            <a href="{{ route('admin.vendors.index') }}" class="back-link">← Back to Vendor List</a>
        </div>
            ...
            <div class="card-content">
                <div class="info-grid">
                    <div class="info-item">
                        ...
                        <div class="info-value">{{ $vendor->user->name }}</div>
                    </div>
                    <div class="info-item">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value">{{ $vendor->business_name }}</div>
                    </div>
                    <div class="info-item">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-value">{{ $vendor->getBusinessTypeLabel() }}</div>
                    </div>
                    <div class="info-item">
                        <div class="info-label">Application Date</div>
                        <div class="info-value">{{ $vendor->created_at->format('M d, Y h:i A') }}</div>
                    </div>
                    <div class="info-item">
            ...
            <div class="card-content">
                <div class="documents-section">
                    <div class="document-item">
                        ...
                        <a href="{{ Storage::url($vendor->citizenship_certificate) }}" target="_blank" class="document-link">View Document</a>
                    </div>
                    <div class="document-item">
                        <span class="document-name">Company Registration Certificate</span>
                        <a href="{{ Storage::url($vendor->company_registration_certificate) }}" target="_blank" class="document-link">View Document</a>
                    </div>
                    @if($vendor->tax_certificate)
                        <div class="document-item">
                            <span class="document-name">Tax Certificate</span>
                            <a href="{{ Storage::url($vendor->tax_certificate) }}" target="_blank" class="document-link">View Document</a>
                        </div>
                    @endif
                </div>
            </div>
