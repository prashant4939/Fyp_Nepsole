                    ...
                    <div class="revenue-display">
                        <div class="revenue-bar-container">
                            <div class="revenue-bar revenue-bar-weekly" style="width: 100%">
                                <span class="revenue-value">Rs. {{ number_format($revenueData['weekly'], 2) }}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="revenue-display">
                        <div class="revenue-bar-container">
                            <div class="revenue-bar revenue-bar-monthly" style="width: 100%">
                                <span class="revenue-value">Rs. {{ number_format($revenueData['monthly'], 2) }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="x-axis-label">Time Period</div>
                    ...
                    <div class="revenue-display">
                        <div class="revenue-bar-container">
                            <div class="revenue-bar revenue-bar-yearly" style="width: 100%">
                                <span class="revenue-value">Rs. {{ number_format($revenueData['yearly'], 2) }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="x-axis-label">Time Period</div>
