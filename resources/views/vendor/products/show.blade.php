...
@section('title', 'View Product - Vendor')
...
<div class="page-header-modern">
    <div class="header-content">
        ...
        <div class="header-actions">
            <a href="{{ route('vendor.products.edit', $product) }}" class="btn-edit">
    ...
    <div class="view-sidebar">
        <div class="stats-card">
            ...
            <div class="stat-item">
                ...
                <div>
                    <div class="stat-value">{{ $product->images->sum(function($img) { return $img->variants->sum('stock'); }) }}</div>
                                ...
                                <div class="sizes-preview">
                                    @foreach($image->variants as $variant)
                                        <div class="size-badge">
                                            ...
                                            <span class="stock">{{ $variant->stock }} units</span>
                                        </div>
                                    @endforeach
                                </div>
                            @else
        ...
        @else
            <div class="empty-card">
                ...
                <a href="{{ route('vendor.products.edit', $product) }}" class="btn-add">Add Images</a>
            </div>
        @endif
    </div>
</div>
