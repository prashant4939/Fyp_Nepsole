...
@section('title', 'Shopping Cart - NepSole')
            ...
            <div class="cart-layout">
                    ...
                    @foreach($cartItems as $item)
                        <div class="cart-item" data-cart-id="{{ $item->id }}">
                            ...
                            <div class="item-details">
                                ...
                                @if($item->variant)
                                    <p class="item-size">Size: <strong>{{ $item->variant->size }}</strong></p>
                                @endif
                            ...
                            <div class="item-subtotal">
                                ...
                                <p class="subtotal-amount" id="subtotal-{{ $item->id }}">Rs. {{ number_format($item->quantity * $item->product->price, 2) }}</p>
                            </div>
                ...
                <div class="cart-summary">
                    ...
                    <div class="summary-row">
                        ...
                        <span id="cartSubtotal">Rs. {{ number_format($subtotal, 2) }}</span>
                    </div>
                    ...
                    <div class="summary-row total">
                        <span>Total</span>
                        <span id="cartTotal">Rs. {{ number_format($subtotal, 2) }}</span>
                    </div>
                    
                    <button class="checkout-btn" onclick="window.location.href='{{ route('checkout.index') }}'">
                        Proceed to Checkout
                        <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
