...
@section('title', 'Change Password - NepSole')
...
<div class="cp-page">
    <div class="cp-container">
        ...
        <div class="cp-card">
            ...
            <!-- Form -->
            <form method="POST" action="{{ route('settings.update-password') }}" id="changePasswordForm">
                @csrf
                @method('PUT')
                ...
                <div class="cp-field">
                    ...
                    <div class="cp-input-wrap">
                        <input type="password"
                               ...
                               id="currentPassword"
                               class="cp-input @error('current_password') cp-input-error @enderror"
                ...
                <div class="cp-actions">
                    ...
                    <a href="{{ route('settings.profile') }}" class="cp-btn-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
